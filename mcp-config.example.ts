...
> = {
  ...
  // Surfaces to the model as mcp__connect-google__connect. The bot intercepts
  // tool calls and renders Telegram OAuth inline-keyboard buttons via
  // src/handlers/streaming.ts:checkPendingConnectGoogleRequests.
