...
const TOXIC_SUBSTRINGS = [
  ...
  // Подстроки требуют технического контекста, чтобы не ловить бытовые
  // «отклонено» (iPhone со сколами) или «бесплатном тарифе» (описание API).
  "отказано — бесплатн",
  "отказано — требуется",
  "отказано — тариф",
  "отклонено — бесплатн",
  ...
  "отклонено — тариф",
  "отказано — недоступн",
  "требуется тариф проф",
  "недоступно на бесплатном тариф",
  ...
  "попытка чтения /sys",
  "попытка чтения /root",
  "попытка запуска bash",
  "попытка выполнения bash",
  "запрос sha256",
  "запросы команд bash",
  "запрос команд bash",
  "запрос на bash",
  "запуск bash",
  "чтение системных файл",
];
